...
# =====================================================================
# VENDEDOR PANEL — Panel de Atención / Oficina
# =====================================================================

class ClienteRapidoForm(forms.ModelForm):
    """Form para crear o editar un cliente rápidamente desde el panel vendedor."""
...
class VendedorOrderForm(forms.Form):
    """Form para que el vendedor cree un pedido a nombre de un cliente."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['client_id'].choices = [('', '— Seleccionar cliente —')] + [
            (u.id, f"{u.get_full_name() or u.username} ({u.telefono})") for u in clients
        ]
        now = timezone.now()
